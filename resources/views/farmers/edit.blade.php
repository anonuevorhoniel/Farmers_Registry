    ...
    <form method="PUT" action="/farmers/{{ $farmer->id }}/update">
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <input type="text" class="form-control" name="name_extension" value="{{ $farmer->name_extension }}"
                    id="exampleInputPassword1">
            </div>
            <div class="col-3">
                <label for="exampleInputPassword1" class="form-label">Birth Date <b style="color: red">*</b></label>
                <input type="date" class="form-control" name="birth_date" value="{{ $farmer->birth_date }}"
                    id="exampleInputPassword1">
            </div>
        </div>
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" class="form-control" name="birth_place" value="{{ $farmer->birth_place }}"
                    id="exampleInputPassword1">
            </div>
            <div class="col-2">
                <label for="">Sex <b style="color: red">*</b></label>
                <input type="text" class="form-control" name="sex" value="{{ $farmer->sex }}"
                    id="exampleInputPassword1">
            </div>
            <div class="col-4">
                <label for="">Contact Number <b style="color: red">*</b></label>
                <input type="text" class="form-control" name="contact_number" value="{{ $farmer->contact_number }}"
                    id="exampleInputPassword1">
            </div>
        </div>
        <div class="row">
