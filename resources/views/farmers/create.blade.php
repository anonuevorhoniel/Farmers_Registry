    ...
    <form method="POST" action="/farmers/store">
        ...
        <div class="row">
            <div class="col-6">
                ...
                <input type="text" class="form-control" name="other_information" value="{{ old('other_information') }}"
                    id="exampleInputPassword1">
            </div>
            <div class="col-6">
                <label for="">Farm Name <b style="color: red">*</b></label>
                <select name="farm_id"class="form-control" value="{{ old('farm_name') }}" id="farm_id">
                    @if ($farms->count() > 0)
        ...
        <div class="row">
            <div class='col-12'>
                ...
                <select name="farmer_type_id" class="form-control" value="{{ old('farm_type') }}" id="farmer_type_id">
                    @if ($types->count() > 0)
